...
{
    /*
     * ±éÀúvector ,¶ÔÁ¢ÃæµÄÃ¿¸ö³ÉÔ±µ÷ÓÃÎö¹¹·½·¨,ÊÍ·Å,È»ºóÊÍ·ÅÕû¸öÈÝÆ÷
     */
...
{
    /* 
       1. ¸ù¾ÝuiCapaticy ÕÒµ½±¾´ÎÒªµ÷ÕûµÄ´óÐ¡
       2. ÖØÐÂ·ÖÅä¿Õ¼ä
       3. °ÑÔ­À´µÄvectorÄÚÈÝ¿½±´µ½ÐÂµÄ¿Õ¼ä
       */
    UINT32  uiRet           = OK;
    void*   pData           = NULL;
    UINT32  uiReCapacity    = 0;

    /* ÐÂÉêÇëµÄÃ»Ä¬ÈÏµÄ´ó£¬²»ÐèÒªµ÷Õû */
...
/* @ desc   : vector Ìí¼ÓÔªËØµ½vector µÄÊ×¸ö¿ÕÎ»ÖÃ 
 * @ input  : 
 *              pstVector
 *              pObj        ´ýÌí¼ÓµÄ¶ÔÏóÖ¸Õë
 * @ output :   suc or failed
 * @ cautious: 
 */
...
{
    /* ½ö½öÊÇµ¯³ö¶ÔÏó£¬²»¶Ô¶ÔÏó²Ù×÷£¬Ö»¹ÜÀí vector */
